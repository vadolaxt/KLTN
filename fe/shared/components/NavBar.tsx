...
const NAV_LINKS = [
  ...
  { label: 'Tra cứu', href: '#' },
  { label: 'Hồ sơ', href: '#' },
  { label: 'Dự đoán trúng tuyển', href: '#' },
  { label: 'Cẩm nang', href: '#' },
  { label: 'Liên hệ', href: '#' },
];
      ...
      {NAV_LINKS.map((link) => {
        ...
        return (
          <Link
            ...
            className={`text-[14px] font-semibold px-[22px] py-[14px] block tracking-[0.2px] transition-all duration-200 border-b-[3px] no-underline ${isActive
